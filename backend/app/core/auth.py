...
async def get_current_user(
    ...
    yahoo_session: Optional[str] = Cookie(default=None, alias="fantasy_yahoo_session"),
    ...
    token = credentials.credentials if credentials else fantasy_session or yahoo_session
    if not token:
